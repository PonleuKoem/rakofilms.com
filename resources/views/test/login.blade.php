...
<!-- //fonts -->
  ...
  <body>
	    ...
	    <nav class="navbar navbar-inverse navbar-fixed-top">
	      <div class="container-fluid">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="{{URL::to('/')}}"><h1><img src="{{asset('images/logo.png')}}" alt="" /></h1></a>
	        </div>
    ...
    <div class="row">
        ...
        <div id="" class="col-sm-offset-4 col-md-offset-4 col-lg-offset-4 col-sm-4 col-md-4 col-lg-4">
			<div class="row">
				...
				<div class="signin">
					...
					<!-- pop-up-box -->
									...
									<!--//pop-up-box -->
									<!-- <div id="small-dialog1111" class="mfp-hide">
									...
									<div id="small-dialog2" class="mfp-hide">
										...
										<div class="signup">
											...
											{{csrf_field() }}
												...
												<input type="text" name="first_name" class="email" placeholder="First Name" required="required" pattern="([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?" title="Enter a valid email"/>
												<input type="text" name="last_name" class="email" placeholder="Last Name" required="required" pattern="([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?" title="Enter a valid email"/>
												...
												<input type="password" name="password_comfirmation" class="email" placeholder="Confirm Password" required>
				...
				<div class="signin">
					...
					<div id="small-dialog" class="mfp-hide">
						...
						<div class="signup">						
							<form action="/login" method="POST">
								{{csrf_field() }}
								<input type="text" class="email" name="email" placeholder="Enter email / mobile" required>
								<input type="password" name="password" placeholder="Password" required>
								<input type="submit"  value="Sign In"/>
							</form>
							<div class="forgot">
